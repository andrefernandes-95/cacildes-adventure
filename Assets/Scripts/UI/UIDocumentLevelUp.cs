...
namespace AF
{
    public class UIDocumentLevelUp : MonoBehaviour
    {
        ...
        void DrawUI(VisualElement root)
        {
            ...
            // TODO: Dont think this applies anymore
            /*
            ...
            root.Q<VisualElement>("DefenseAbsorption").Q<Label>("Value").text = playerManager.characterBaseDefenseManager.GetPhysicalDamageAbsorption(
                desiredVitality,
                desiredEndurance,
                desiredStrength) + "";
