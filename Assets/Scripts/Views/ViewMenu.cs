...
namespace AF.UI
{
    public class ViewMenu : MonoBehaviour
    {
        ...
        public Sprite keyboardPreviousKey;
        public Sprite gamepadPreviousKey;

        public Sprite keyboardNextKey;
        public Sprite gamepadNextKey;
        ...
        protected virtual void OnEnable()
        {
            ...
            previousKey.style.backgroundImage = new StyleBackground(Gamepad.current != null ? gamepadPreviousKey : keyboardPreviousKey);
            nextKey.style.backgroundImage = new StyleBackground(Gamepad.current != null ? gamepadNextKey : keyboardNextKey);
        }
